...
(function ($) {
  ...
  $.extend($.fn, {
    swapClass: function swapClass(c1, c2) {
      var c1Elements = this.filter('.' + c1);
      this.filter('.' + c2).removeClass(c2).addClass(c1);
      c1Elements.removeClass(c1).addClass(c2);
      return this;
    },
    replaceClass: function replaceClass(c1, c2) {
      return this.filter('.' + c1).removeClass(c1).addClass(c2).end();
    },
    hoverClass: function hoverClass(className) {
    ...
    heightToggle: function heightToggle(animated, callback) {
    ...
    heightHide: function heightHide(animated, callback) {
      if (animated) {
        this.animate({
          height: "hide"
        }, animated, callback);
    ...
    prepareBranches: function prepareBranches(settings) {
    ...
    applyClasses: function applyClasses(settings, toggler) {
    ...
    treeview: function treeview(settings) {
      settings = $.extend({
        cookieId: "treeview"
      }, settings);
